...
- Random-peer load balancing across multiple endpoints, TLS three modes (system / PEM / file), basic + token auth, gzip transport compression.
- 58 unit tests, 8 examples, 3 end-to-end benchmarks mirroring Rust's 22-col log schema.
